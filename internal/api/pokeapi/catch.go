...
var Catch PokemonResult

func (p *PokemonResult) CatchPokemon(url string, pokemon string, cfg *config.Config) (*PokemonResult, error) {
	if cached, ok := pokeCache.Get(pokemon); ok {
		var cachedResult PokemonResult
